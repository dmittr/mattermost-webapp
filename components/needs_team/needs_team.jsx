...
import TutorialView from 'components/tutorial/tutorial_view';
import MessageIdentifierRouter from 'components/message_indentifier_router';
import {makeAsyncComponent} from 'components/async_load';
import BackstageController from 'bundle-loader?lazy!components/backstage/backstage_controller';
...
export default class NeedsTeam extends React.Component {
    ...
    constructor(params) {
        ...
        this.selectLastChannel = this.selectLastChannel.bind(this);
        ...
        if (tutorialStep <= TutorialSteps.INTRO_SCREENS && global.window.mm_config.EnableTutorial === 'true') {
            this.props.history.push(TeamStore.getCurrentTeamRelativeUrl() + '/tutorial');
        }

        const team = this.updateCurrentTeam(this.props);

        this.selectLastChannel(this.props);
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (this.props.match.params.channel !== nextProps.match.params.channel) {
            this.selectLastChannel(nextProps);
        }
    }

    selectLastChannel(props) {
        const team = TeamStore.getByName(props.match.params.team);
        if (!team) {
            return;
        }
        ...
        this.props.history.push(`/${team.name}/channels/${channelName}`);
    }
        ...
        return (
            <Switch>
                <Route
                    ...
                    component={makeAsyncComponent(BackstageController)}
                />
                <Route
                    path={'/:team/emoji'}
                    component={makeAsyncComponent(BackstageController)}
